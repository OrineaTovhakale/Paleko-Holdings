    ...
    <>
      ...
      <div style={{background:'#F8F7F4',minHeight:'100vh'}}>
        ...
        <div ref={heroRef} className={heroClass} style={{position:'relative',height:'480px',overflow:'hidden',background:'#1A1A1A'}}>
          <img src="https://images.squarespace-cdn.com/content/v1/67a0fc26e44aa03348912c8b/278dda95-7b97-495f-8c92-16c840090432/ND7_8815.jpg" alt="Vegetation services" style={{position:'absolute',inset:0,width:'100%',height:'100%',objectFit:'cover',opacity:0.5}} />
        ...
        <div ref={sectionRef} className="page-section">
          <div className="page-split">
            <div className="reveal">
              ...
              <p style={{fontSize:'13px',color:'#666',lineHeight:1.9,fontWeight:300,marginBottom:'16px'}}>
                Our experienced team handles everything from routine grass cutting to large-scale tree felling and chemical weed control. We are a Reg PCO licensed operator.
              </p>
            </div>
            <div className="reveal reveal-delay-2 veg-img-hover">
              <img src="https://images.pexels.com/photos/4792480/pexels-photo-4792480.jpeg?auto=compress&cs=tinysrgb&w=900" alt="Vegetation management" className="img-main-responsive" />
            </div>
          </div>
        ...
        <div ref={section2Ref} className="page-section-sm">
          <div className="strip-grid reveal">
            <div className="veg-strip-wrap">
              <img src="https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=600&q=80&fit=crop" alt="Lawn cutting" className="strip-img-fixed" />
            </div>
            <div className="veg-strip-wrap">
              <img src="https://images.unsplash.com/photo-1563909671921-5db64c428fcc?w=600&q=80&fit=crop" alt="Tree felling" className="strip-img-fixed" />
            </div>
            <div className="veg-strip-wrap">
              <img src="https://images.unsplash.com/photo-1585320806297-9794b3e4aaae?w=600&q=80&fit=crop" alt="Weed control" className="strip-img-fixed" />
            </div>
          </div>
            ...
            <div className="dark-block-grid">
              <div>
                ...
                <p style={{fontSize:'13px',color:'rgba(255,255,255,0.5)',lineHeight:1.85,fontWeight:300,marginBottom:'24px'}}>
                  Paleko Holdings is a registered Pest Control Operator licensed to apply herbicides for the control of unwanted vegetation. Our applications are safe, compliant and highly effective.
                </p>
